...
const Socials = () => {
  ...
  return (
    <div className="w-full flex-row flex justify-end gap-x-2 items-start">
        <svg onClick={() => openExternalLink("github")} className='w-[15%] fill-black dark:fill-white' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <title>Github</title>
          <rect width="24" height="24" fill="none"/>
          <path d="M12,2A10,10,0,0,0,8.84,21.5c.5.08.66-.23.66-.5V19.31C6.73,19.91,6.14,18,6.14,18A2.69,2.69,0,0,0,5,16.5c-.91-.62.07-.6.07-.6a2.1,2.1,0,0,1,1.53,1,2.15,2.15,0,0,0,2.91.83,2.16,2.16,0,0,1,.63-1.34C8,16.17,5.62,15.31,5.62,11.5a3.87,3.87,0,0,1,1-2.71,3.58,3.58,0,0,1,.1-2.64s.84-.27,2.75,1a9.63,9.63,0,0,1,5,0c1.91-1.29,2.75-1,2.75-1a3.58,3.58,0,0,1,.1,2.64,3.87,3.87,0,0,1,1,2.71c0,3.82-2.34,4.66-4.57,4.91a2.39,2.39,0,0,1,.69,1.85V21c0,.27.16.59.67.5A10,10,0,0,0,12,2Z"/>
        </svg>
        <svg onClick={() => openExternalLink("igLink")} className='w-[15%] stroke-black dark:stroke-white' viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none"><path stroke="inherit" strokeWidth="12" d="M96 162c-14.152 0-24.336-.007-32.276-.777-7.849-.761-12.87-2.223-16.877-4.741a36 36 0 0 1-11.33-11.329c-2.517-4.007-3.98-9.028-4.74-16.877C30.007 120.336 30 110.152 30 96c0-14.152.007-24.336.777-32.276.76-7.849 2.223-12.87 4.74-16.877a36 36 0 0 1 11.33-11.33c4.007-2.517 9.028-3.98 16.877-4.74C71.663 30.007 81.847 30 96 30c14.152 0 24.336.007 32.276.777 7.849.76 12.87 2.223 16.877 4.74a36 36 0 0 1 11.329 11.33c2.518 4.007 3.98 9.028 4.741 16.877.77 7.94.777 18.124.777 32.276 0 14.152-.007 24.336-.777 32.276-.761 7.849-2.223 12.87-4.741 16.877a36 36 0 0 1-11.329 11.329c-4.007 2.518-9.028 3.98-16.877 4.741-7.94.77-18.124.777-32.276.777Z"/><circle cx="96" cy="96" r="30" stroke="inherit" strokeWidth="12"/><circle cx="135" cy="57" r="9" fill='none' strokeWidth='5' stroke="inherit"/></svg>
        <svg onClick={() => openExternalLink("linkedin")} className='w-[15%] fill-black dark:fill-white' viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg onClick={toggletheme} className='w-[15%] block dark:hidden' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg onClick={toggletheme} version="1.1" className="w-[15%] dark:block hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1010 1010" enableBackground="new 0 0 1010 1010">
          <g id="sun-sun">
            <g id="sun-fill">
