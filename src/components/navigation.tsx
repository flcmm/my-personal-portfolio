...
const Navigation = () => {
  ...
  return (
    <div className="w-2/12 flex flex-row justify-around items-center">
      <div className='w-1/5' onClick={() => openExternalLink("github")}>
      ...
      <div className='w-1/5' onClick={() => openExternalLink("igLink")}>
      ...
      <div className='w-1/5' onClick={() => openExternalLink("linkedin")}>
