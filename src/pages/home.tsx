...
const Home = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-7 md:gap-10">
      ...
      <div className="flex w-full flex-col bg-white dark:bg-stone-900 gap-5">
        ...
        <div className="w-full flex flex-col gap-4 items-start bg-white dark:bg-stone-900 px-3 md:px-7">
          ...
          <div className="flex self-center flex-row gap-4 justify-center items-center">
            <button onClick={() => {window.open('https://frlnaqn.medium.com/', "_blank")}} className='flex flex-row p-3 gap-4 border-none rounded-md bg-black dark:bg-white text-white dark:text-black'>
              View All On Medium
              <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" className='fill-white dark:fill-black'><rect fill="none" height="24" width="24"/><path d="M9,6L9,6c0,0.56,0.45,1,1,1h5.59L4.7,17.89c-0.39,0.39-0.39,1.02,0,1.41h0c0.39,0.39,1.02,0.39,1.41,0L17,8.41V14 c0,0.55,0.45,1,1,1H18c0.55,0,1-0.45,1-1V6c0-0.55-0.45-1-1-1H10C9.45,5,9,5.45,9,6z"/></svg>
            </button>
          </div>
        </div>
      </div>
