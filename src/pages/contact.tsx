...
const Contact = () => {
  return (
    <div className="px-5 w-full flex flex-col gap-16 justify-center">
      ...
      <div className="w-11/12 flex flex-col gap-10 text-left">
      ...
      <div className='flex flex-col justify-center items-center w-full text-center gap-10'>
        ...
        <a className=' p-4 bg-black dark:bg-white rounded-md text-white dark:text-black font-semibold' href='mailto:froilanaquino1@gmail.com'>Send Me An Email</a>
      </div>
    </div>
  )
}
